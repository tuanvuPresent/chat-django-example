import logging
from api.core.constants import Language

from rest_framework.exceptions import APIException, ErrorDetail
from rest_framework.response import Response
from rest_framework.views import exception_handler

from api.core.constants import ErrorCode, Error
from api.core.base_response import CustomResponse
...
def custom_exception_handler(exc, context):
    ...
    return Response(
        data=CustomResponse(
            ...
            message=error[Error.message][Language.VI],
            data=detail
        ).data,
        status=status_code
    )
